...
func TestGetConfigPath(t *testing.T) {
	...
	got := GetConfigPath()
	want := filepath.Join("/tmp/home", ".nanoclaw", "config.json")
...
func TestGetConfigPath_Windows(t *testing.T) {
	...
	got := GetConfigPath()
	want := filepath.Join(testUserProfilePath, ".nanoclaw", "config.json")
...
func TestGetConfigPath_WithEnv(t *testing.T) {
	t.Setenv("NANOCLAW_CONFIG", "/tmp/custom/config.json")
