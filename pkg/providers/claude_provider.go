...
import (
	...
	anthropicprovider "github.com/probnotas/nanoClaw/pkg/providers/anthropic"
)
...
func createClaudeTokenSource() func() (string, error) {
	return func() (string, error) {
		...
		if cred == nil {
			return "", fmt.Errorf("no credentials for anthropic. Run: nanoclaw auth login --provider anthropic")
		}
