...
func TestResolveWorkspace(t *testing.T) {
	result := ResolveWorkspace("/home/user/.nanoclaw")
	assert.Equal(t, "/home/user/.nanoclaw/workspace", result)
}

func TestRelPath(t *testing.T) {
	result := RelPath("/home/user/.nanoclaw/workspace/file.txt", "/home/user/.nanoclaw")
...
func TestResolveTargetHome(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, filepath.Join(home, ".nanoclaw"), result)
}
