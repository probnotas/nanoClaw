...
// NanoChannel implements the native Pico Protocol WebSocket channel.
...
// NewNanoChannel creates a new Pico Protocol channel.
...
func (c *NanoChannel) Start(ctx context.Context) error {
	logger.InfoC("nano", "Starting Pico Protocol channel")
	c.ctx, c.cancel = context.WithCancel(ctx)
	c.SetRunning(true)
	logger.InfoC("nano", "Pico Protocol channel started")
	return nil
}

// Stop implements Channel.
func (c *NanoChannel) Stop(ctx context.Context) error {
	logger.InfoC("nano", "Stopping Pico Protocol channel")
	c.SetRunning(false)
	...
	logger.InfoC("nano", "Pico Protocol channel stopped")
	return nil
}

// WebhookPath implements channels.WebhookHandler.
func (c *NanoChannel) WebhookPath() string { return "/pico/" }
...
func (c *NanoChannel) broadcastToSession(chatID string, msg PicoMessage) error {
...
func (c *NanoChannel) readLoop(pc *picoConn) {
	defer func() {
		pc.close()
...
func (c *NanoChannel) pingLoop(pc *picoConn, interval time.Duration) {
...
func (c *NanoChannel) handleMessage(pc *picoConn, msg PicoMessage) {
	switch msg.Type {
	case TypePing:
...
func (c *NanoChannel) handleMessageSend(pc *picoConn, msg PicoMessage) {
