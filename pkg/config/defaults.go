...
// DefaultConfig returns the default configuration for NanoClaw.
func DefaultConfig() *Config {
	// Determine the base path for the workspace.
	// Priority: $NANOCLAW_HOME > ~/.nanoclaw
	var homePath string
	if nanoclawHome := os.Getenv("NANOCLAW_HOME"); nanoclawHome != "" {
		homePath = nanoclawHome
	} else {
		userHome, _ := os.UserHomeDir()
		homePath = filepath.Join(userHome, ".nanoclaw")
	}
