...
INTERNAL=github.com/probnotas/nanoClaw/cmd/nanoclaw/internal
...
WORKSPACE_DIR?=$(NANOCLAW_HOME)/workspace
...
## build: Build the nanoclaw binary for current platform
build: generate
...
## build-all: Build nanoclaw for all platforms
build-all: generate
	@echo "Building for multiple platforms..."
	@mkdir -p $(BUILD_DIR)
...
## install: Install nanoclaw to system and copy builtin skills
install: build
...
## uninstall: Remove nanoclaw from system
uninstall:
...
## uninstall-all: Remove nanoclaw and all data
uninstall-all:
	@echo "Removing workspace and skills..."
	@rm -rf $(NANOCLAW_HOME)
	@echo "Removed workspace: $(NANOCLAW_HOME)"
...
## run: Build and run nanoclaw
run: build
	@$(BUILD_DIR)/$(BINARY_NAME) $(ARGS)

## help: Show this help message
help:
	@echo "nanoclaw Makefile"
	@echo ""
	@echo "Usage:"
	@echo "  make [target]"
	@echo ""
	...
	@echo "  WORKSPACE_DIR           # Workspace directory (default: ~/.nanoclaw/workspace)"
